package com.alexandnovik.camera.data.camera
...
import com.alexandnovik.camera.utils.Logger
...
class AppCamera {
    ...
    fun openCamera(view: View, owner: LifecycleOwner) {
        ...
        Logger.d("[Camera] Screen metrics: ${metrics.widthPixels} x ${metrics.heightPixels}")
